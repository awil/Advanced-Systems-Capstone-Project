...
<div class="container">
    <div class="row my-5">
        <div class="card bg-light shadow">
            <div class="card-body">
            <h2><?php echo htmlspecialchars($current_admin->getFirstName());?>'s Profile</h2>
            ...
            <div class="pl-lg-4">
                <div class="row mb-2">
                    <div class="col-lg-6">
                        ...
                        <label class="form-control-label" for="adm_first">First</label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label class="form-control-label" for="adm_last">Last</label>
                ...
                <div class="row mb-2">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label class="form-control-label" for="adm_title">Title</label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label class="form-control-label" for="adm_email">Email</label>
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="form-group">
                        <label class="form-control-label" for="adm_password_1">Password</label>
                        <input type="password" name="adm_password_1" id="adm_password_1" class="form-control form-control-alternative" value=""/>                        
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                        <label class="form-control-label" for="adm_password_2">Confirm Password</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                        <input class="btn btn-sm btn-primary" type="submit" value="Update Information" />
                        </div>
                    </div>
                </div>
            </div>
